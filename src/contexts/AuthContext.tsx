...
export const authorizedUsers = {
  students: [
    { email: 'student1@example.com', password: 'student123', id: 's1' },
    { email: 'student2@example.com', password: 'student456', id: 's2' },
    { email: 'student3@example.com', password: 'student789', id: 's3' },
    { email: 'student4@example.com', password: 'student012', id: 's4' },
  ],
  faculty: [
    { email: 'faculty1@example.com', password: 'faculty123', id: 'f1' },
    { email: 'faculty2@example.com', password: 'faculty456', id: 'f2' },
  ],
  admin: [
    { email: 'admin@example.com', password: 'admin123', id: 'a1' }
  ]
};
