...
import { Calendar, CheckCircle, Clock, AlertCircle, Plus, X, Eye } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-2xl w-full p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={() => setShowResultModal(false)} className="text-gray-500">
                <X className="w-6 h-6" />
              </button>
            </div>
                ...
                {selectedAssessment.questions.map((question, index) => (
                  <div key={index} className="border rounded-lg p-4">
                    ...
                    <div className="text-sm">
                      <div className="text-gray-600">Your answer: {selectedAssessment.answers?.[index]}</div>
