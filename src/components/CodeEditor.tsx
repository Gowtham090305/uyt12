    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between p-4 bg-gray-800 text-white">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-semibold">AI-Powered Code Assistant</span>
        </div>
      ...
      <div className="flex flex-1">
        ...
        <div className="w-1/4 bg-gray-50 overflow-y-auto flex flex-col">
          <div className="p-4 border-b">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold">Exercise Help</h3>
                ...
                {errors.map((error, index) => (
                  <div key={index} className="bg-red-50 p-3 rounded-lg">
                    <div className="flex items-center mb-1">
                      ...
                      <span className="font-medium text-red-700">Line {error.line + 1}</span>
                    </div>
